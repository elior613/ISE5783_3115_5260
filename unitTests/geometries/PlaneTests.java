...
//
    ...
    public void testFindIntersections() {
        ...
        assertNull(plane.findIntersections(new Ray(new Point(2, 3, 0), new Vector(1, 0, 0))),
                "Ray's line included in the plane");
        // TC12: Ray doesn't included in the plane (0 points)
        assertNull(plane.findIntersections(new Ray(new Point(2, 3, 1), new Vector(1, 0, 0))),
        ...
        // TC15: Ray starts before (1 point)
        ...
        assertNull(plane.findIntersections(new Ray(new Point(2, 3, 0), new Vector(1, 1, 1))),
                "Ray not at the plane");

        // **** Ray is neither orthogonal nor parallel to and begins at the plane
        // TC17: begins in the same point which appears as reference point in the plane (0 points)
